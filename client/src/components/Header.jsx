...
import logo from '../../src/assets/WorldWire-Icon.png'
 ...
 function Header() {
  ...
  return (
    <nav className="relative flex w-full flex-wrap items-center justify-between bg-[#FBFBFB] py-2 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-neutral-600 lg:py-2" data-te-navbar-ref>
      <div className='flex w-full flex-wrap items-center justify-between px-3'>
        <div><img src={logo} className='w-10'></img></div>
        {isLoggedIn() ? (
          <>
